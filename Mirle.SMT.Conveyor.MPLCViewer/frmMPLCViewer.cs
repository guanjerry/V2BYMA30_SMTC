...
{
    public partial class frmMPLCViewer : Form
    {
        private FileReader _fReader;
        private IMPLCViewController _mplcViewController;
        private string[] _filePaths;
        public frmMPLCViewer()
        {
            InitializeComponent();
        }

        private void frmMPLCViewer_Load(object sender, EventArgs e)
        {
            try
            {
                _mplcViewController = null;
                _mplcViewController = LoadMPLCViewControllerByFile("Mirle.SMTCV.Conveyor.Controller.dll");
