...
namespace Mirle.WebAPI.Function
{
    public class CommandUpdate
    {
        ...
        public CommandUpdate(WebApiConfig Config)
        {
            _config = Config;
        }

        public bool FunReport(CommandReport info)
        {
            try
            {
                ...
                ReplyCommandReport info_wcs = (ReplyCommandReport)Newtonsoft.Json.Linq.JObject.Parse(re).ToObject(typeof(ReplyCommandReport));
