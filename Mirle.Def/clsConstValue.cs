...
namespace Mirle.Def
{
    public class clsConstValue
    {
        ...
        public class CmdSts
        {
            ...
            /// 執行中
            /// </summary>
            public const string Running = "2";
            /// <summary>
            /// 7:命令完成待過帳
            /// </summary>
            public const string FinishToCV = "3";
            /// <summary>
            /// 7:命令完成待過帳
            /// </summary>
            public const string FinishWaitingPost = "7";
            /// <summary>
            /// 8:命令取消待過帳
            /// </summary>
        ...
        public class CmdAbnormal
        {
            public const string EmptyRetrieval = "E2";
            public const string DoubleStorage = "EC";
            public const string PlaceRetry = "ER";
            public const string PlaceFail = "EF";
            public const string RetrieveFail = "EG";
            public const string NoAbnormal = "NA";
        }
        ///<summary>
        ///作業類別 
        ///</summary>
