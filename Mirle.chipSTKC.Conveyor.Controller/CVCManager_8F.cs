using Mirle.SMTCV.Conveyor.V2BYMA30.Signal;
...
namespace Mirle.SMTCV.Conveyor.Controller
{
    public class CVCManager_8F : IDisposable
    {
        ...
        public V2BYMA30.Buffer GetBuffer(int bufferIndex)
        {
        ...
        public V2BYMA30.Signal.SignalMapper GetSignalMapper()
        {
            return _Signal;
        }
        ...
        private void InitialBuffer()
        {
            ...
            {
                var buffer = new V2BYMA30.Buffer(_Signal.GetBufferSignal(i), "CV");
